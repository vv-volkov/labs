...
% (0.1, 0.01, 3, 12) автоколебательный режим
% (0.36, 0.02, 6, 15) относительно большая частота
% (0.36, 0.02, 6, 7) относительно высокая амплитуда
% (0.3, 0.02, 6, 18) затухающие колебания

% (0.36, 0.02, 6, 7) -> (1.2, 0.02, 6, 7) - все еще осциллирующе поведение
% (0.36, 0.02, 6, 15) -> (1.2, 0.02, 6, 15) - -//-
% (0.1, 0.01, 3, 12) -> (0.5, 0.01, 3, 12) - -//- 
% (0.1, 0.01, 3, 12) -> (0.9, 0.01, 3, 12) - быстрое затухание
% (0.1, 0.01, 3, 12) -> (1.17, 0.01, 3, 12) - ^^^ качественное изменение
